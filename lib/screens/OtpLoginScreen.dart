...
import '../modules/OtpLoginScreen/OtpLoginScreen_controller.dart';
import '../widgets/button.dart';

class OtpLoginScreen extends StatelessWidget {
  final OtpLoginScreenController otpScreen;

  const OtpLoginScreen(this.otpScreen, {Key? key}) : super(key: key);
